...
export const UpdateprofileComponent: React.FC<UpdateprofileComponentProps> = ({ data = {}, onSubmit }) => {
    ...
    const { _csrf, address, email, handleSubmit, userid, username } = data;
    ...
    return (
        <div className="updateprofilecomponent-wrapper" onChange={handleInputChange}>
            <!doctype html>
            ...
            <div className="col-sm-6">
                ...
                <form onSubmit={handleSubmit} action="updateuser" method="post">
                    ...
                    <div className="form-group">
                        ...
                        <input type="email" className="form-control form-control-lg" required minlength="6" placeholder="Email*" value={email } required name="email" id="email"
                    ...
                    <div className="form-group">
                        ...
                        <input type="password" className="form-control form-control-lg" placeholder="Leave blank to keep existing password" name="password"
                               id="password">
                    </div>
                    <div className="form-group">
