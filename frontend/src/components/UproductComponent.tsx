...
type UproductComponentProps = {
    data?: Record<string, any>;
    onSubmit?: (formData: Record<string, any>) => void | Promise<void>;
};

export const UproductComponent: React.FC<UproductComponentProps> = ({ data = {}, onSubmit }) => {
    const [formData, setFormData] = useState<Record<string, any>>({});
    const { handleSubmit, product, products } = data;
    ...
    return (
        <div className="uproductcomponent-wrapper" onChange={handleInputChange}>
            <!doctype html>
        		...
        		<table className="table">
        			...
        			<c:forEach var="product" items={products}>
        				<tr>
        				    ...
        				    <form onSubmit={handleSubmit} action="products/addtocart" method="get">
...
export default UproductComponent;
